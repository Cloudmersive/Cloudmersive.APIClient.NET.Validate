...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.Validate/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.Validate.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.Validate.dll \
-recurse:'src/Cloudmersive.APIClient.NET.Validate/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.Validate.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.Validate.dll was created successfully"
fi
